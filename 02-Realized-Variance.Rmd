...
We now forecast a variance for the next month as follows:

$$
\sigma^2_{t+1} = \alpha + \beta_1RV_{1d} + \beta_2RV_{1w} +\beta_3RV_{1m} + \beta_4\text{IPC-VIX} + u_i
$$
...
=\alpha + \beta \ \big(RV - \text{IPC-VIX}\big) + u_i
$$